...
for j=n_epsilon_range:-1:1
    ...
    for i=1:number_of_exp
        ...
        [tau_PSBAI,hatx_varepsilon,flag_PSBAI,l_PSBAI,tau_naive,x_dot_varepsilon,flag_naive,l_naive,rho,alpha,xi,DE,beta_clip1] = PSBAI_plus_func(X,Theta,ptheta,Ptheta,Lmin_gt,Lmax,varepsilon,w,gamma,b,delta,C_fixed,seed);
        % store the results
